...
Step 5: Data Analysis & Visualization (Modular Version)

This module contains a single function, run_step5_analysis, which:
1. Loads a final curated CSV (default: "ProcessedData.csv")
2. Performs data exploration, summary statistics, and missing-value checks
3. Generates histograms, box plots, bar charts, line charts
4. Runs a Pearson correlation and two-sample t-test
5. Prints and displays all results in the console and with matplotlib
...
def run_step5_analysis(csv_file: str = "ProcessedData.csv"):
    ...
    print("You may include these outputs in your final Project 2 report or PDF.")
